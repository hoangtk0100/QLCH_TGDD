...
namespace QLCuaHang_TGDD
{
    public partial class frmMain : Form
    {
        ...
        void Reset()
        {
            pnlEmployee.Enabled = pnlCustomer.Enabled = pnlProduct.Enabled = pnlEvent.Enabled = pnlStore.Enabled=tabPage1.Enabled= tabImport.Enabled=tabExport.Enabled = pnlExportBill.Enabled= pnlImportBill.Enabled= false;
            ...
            btnEmployee.BackColor = btnCustomer.BackColor = btnProduct.BackColor = btnEvent.BackColor = btnStore.BackColor = btnStatistic.BackColor =btnImportBill.BackColor = btnExportBill.BackColor = Color.Transparent;
            btnEmployee.Normalcolor = btnCustomer.Normalcolor = btnProduct.Normalcolor = btnEvent.Normalcolor = btnStore.Normalcolor = btnStatistic.Normalcolor =btnImportBill.Normalcolor= btnExportBill.Normalcolor=Color.Transparent;
            Add = false;
            dt = null; ds = null;
        ...
        private void btnImportBill_Click(object sender, EventArgs e)
        {
            ...
            tabImport.Location = pnlEmployee.Location;
            tabImport.Enabled = true; tabImport.Show();
          
            pnlImportBill.Location = pnlEmployee.Location;
        ...
        private void btnExportBill_Click(object sender, EventArgs e)
        {
            ...
            tabExport.Location = pnlEmployee.Location;
            tabExport.Enabled = true; tabExport.Show();

            pnlExportBill.Location = pnlEmployee.Location;
